...
function secondKill() {
  //获取所以数字
  var str_time = document.getElementsByClassName('str')[0];
  var str_num = document.getElementsByClassName('num')[0];
  ...
  var timer = setInterval(function () {
    ...
    str_num[3].innerHTML = minutess % 10;
